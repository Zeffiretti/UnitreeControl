...
#include "simulator/mujoco/src/mujoco/simulate.h"
...
int main(int argc, char** argv) {
  ...
  std::string scene_path = src_file_path.substr(0, src_file_path.find_last_of("/")) + "/../../unitree_robots/" +
                           config.robot + "/" + config.robot_scene;
